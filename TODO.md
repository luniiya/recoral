...
- [ ] Real waveform visualization (the actual wavy blue bars in Google Recorder's player) is still not built, that needs Web Audio API decoding + canvas rendering and was scoped out of the card rework as a separate chunk of work.
